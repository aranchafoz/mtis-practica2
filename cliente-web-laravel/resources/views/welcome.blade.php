            ...
            <div class="content">
                ...
                <div class="links">
                  ...
                  <div class="section-form">
                    <form action="{{ action('RestController@validarNIF') }}" method="POST">
                      {{ csrf_field() }}
                      <div class="div-form">
                        ...
                        <div class="operations-forms">
                          <input type="text" name="restKey" id="restKey" class="input-grow"  value="{{ old('restKey') }}"/>
                        </div>
                      </div>
                      <div class="div-form">
                        <div class="operations">
                  ...
                  <!-- IBAN Validation -->
                  <div class="section-form">
                    <form action="{{ action('RestController@validarIBAN') }}" method="POST">
                      {{ csrf_field() }}
                      <div class="div-form">
                        <div class="operations">
                          <p>Rest Key</p>
                  ...
                  <!-- CP -->
                  <div class="section-form">
                    <form action="{{ action('RestController@consultarCP') }}" method="POST">
                      {{ csrf_field() }}
                      <div class="div-form">
                        <div class="operations">
                          <p>Rest Key</p>
                  ...
                  <!-- PRESUPUESTO -->
                  <div class="section-form">
                    <form action="{{ action('RestController@generarPresupuesto') }}" method="POST">
                      {{ csrf_field() }}
                      <div class="div-form">
                        <div class="operations">
                          <p>Rest Key</p>
